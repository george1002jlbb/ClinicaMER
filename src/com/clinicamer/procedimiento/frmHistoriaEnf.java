...
import static com.clinicamer.procedimiento.frmHistoria.logica;
 ...
 */
public class frmHistoriaEnf extends javax.swing.JInternalFrame {

    /**
     * Creates new form frmHistoriaEnf
     */
    public frmHistoriaEnf() throws Exception {
        initComponents();
        this.llenarcboHistoria();
        this.llenarcboEnfermedad();
    }
    ...
    public void llenarcboEnfermedad() throws NoSuchAlgorithmException, Exception {
        cboEnf.removeAllItems();
        try {
            List<Enfermedad> l = new LinkedList<Enfermedad>();
            l = logica.consultarTodosEnfermedad();
            for (int i = 0; i < l.size(); i++) {
                cboEnf.addItem(new Combo(l.get(i).getIdenfermedad(), l.get(i).getNombre()));
            }
        } catch (SQLException ex) {
            Logger.getLogger(frmHistoriaEnf.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
    ...
    private void initComponents() {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cboEnf, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(46, 46, 46)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addComponent(cboEnf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        try {
            ...
            he.setIdenfermedad(cboEnf.getItemAt(cboEnf.getSelectedIndex()).getIdCombo());
            he.setIdhistoria(cboHis.getItemAt(cboHis.getSelectedIndex()).getIdCombo());

            logica.guardarHistoriaEnf(he);
            JOptionPane.showMessageDialog(this, "Enfermedad agregado correctamente", "Cirugia", JOptionPane.INFORMATION_MESSAGE);
    ...
    private javax.swing.JComboBox<Combo> cboEnf;
